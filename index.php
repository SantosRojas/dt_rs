...
if(isset($_SESSION['usuario'])) {
    // Si el usuario está logueado, redirígelo a home.php
...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html">
	<img class="mb-4" src="dist/img/logo.png" alt="" width="75%" height="auto">
	</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="cnx/login.php" method="post">
        <div class="input-group mb-3">
          <input type="text" name="usuario" class="form-control" placeholder="4-2-2">
