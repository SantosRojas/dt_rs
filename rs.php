...
<html lang="en">
	<head>
		...
		<style>
			#listaArchivos, #listaArchivosEdit {
	...
	<body id="body" class="hold-transition sidebar-mini sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
							...
							<li class="nav-item <?= $arttipo !='PRODUCTO AE' ? 'menu-open' : '' ?>">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item menu-open">
										...
										<ul class="nav nav-treeview">
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA AVITUM" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA AVITUM"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA AVITUM"){echo "text-success";} ?>"></i>
													<p>Producto L&iacute;nea AVITUM</p>
												</a>
											</li>										
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA HC AIS" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA HC AIS"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA HC AIS"){echo "text-success";} ?>"></i>
													<p>Producto L&iacute;nea HC AIS</p>
												</a>
											</li>
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA HC BC" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA HC BC"){echo "active";} ?>">
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA HC BC"){echo "text-success";} ?>"></i>
													<p>Producto L&iacute;nea HC BC</p>
												</a>
											</li>
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA HC CN" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA HC CN"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA HC CN"){echo "text-success";} ?>"></i>
													<p>Producto L&iacute;nea HC CN</p>
												</a>
											</li>
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA HC PC VA" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA HC PC VA"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA HC PC VA"){echo "text-success";} ?>"></i>
													<p>Producto L&iacute;nea HP PC VA</p>
												</a>
											</li>
											<li class="nav-item">
												<a href="rs.php?arttipo=PRODUCTO LINEA OPM" class="nav-link" <?php if($arttipo=="PRODUCTO LINEA OPM"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO LINEA OPM"){echo "text-success";} ?>"></i>
									...
									<li class="nav-item <?= $arttipo =='PRODUCTO AE' ? 'menu-open' : '' ?>">
										...
										<ul class="nav nav-treeview">
											<li class="nav-item">
												<a href="rs_ae.php?arttipo=PRODUCTO AE" class="nav-link" <?php if($arttipo=="PRODUCTO AE"){echo "active";} ?> >
													<i class="far fa-dot-circle nav-icon <?php if($arttipo=="PRODUCTO AE"){echo "text-success";} ?>"></i>
													<p>Producto AE</p>
												</a>
											</li>											
							...
							<div class="col-12">
								<div class="card card-secondary">
									<div class="card-header">
										<h3 class="card-title">MAESTROS | Registros Sanitarios - <?php echo $arttipo; ?></h3>
									...
									<div class="card-body">
										<div class="btn-group btn-group-toggle mt-3 mb-1" data-toggle="buttons">
											...
											<input type="radio" name="filtro1" id="" autocomplete="off" checked=""> Todos
											</label>
											<label class="btn btn-success">
											<input type="radio" name="filtro1" id="VENCIDO" autocomplete="off"> Vencidos
											</label>
											<label class="btn btn-success">
											<input type="radio" name="filtro1" id="VENCE_1_MES" autocomplete="off"> Vence 1 Mes
											</label>
											<label class="btn btn-success">
											<input type="radio" name="filtro1" id="VENCE_2_MESES" autocomplete="off"> Vence 2 Meses
											</label>
											<label class="btn btn-success">
											<input type="radio" name="filtro1" id="VENCE_3_MESES" autocomplete="off"> Vence 3 Meses
											</label>
										</div>
										<table id="registrosanitario" class="display compact cell-border table-striped hover" style="width:100%">
											<thead>
												<tr>
		...
		<button type="button" id="btneditmodal" name="btneditmodal" class="btn btn-primary" data-toggle="modal" data-target="#editModal" hidden>Edit Modal</button>
		<!-- Modal -->
										...
										<div class="card card-success">
											<div class="card-header">
												<h4 class="card-title w-100">
													<a id="tabarticuloedit" class="d-block w-100" data-toggle="collapse" href="#collapseOne">
													<span id="artcoddes">Informaci&oacute;n del Producto</span> <i class="fas fa-arrow-circle-right"></i>
													</a>
												</h4>
											</div>
											<div id="collapseOne" class="collapse" data-parent="#accordion">
												<div class="card-body">
													...
													<div class="row">	
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="fabricante" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>													
														<div class="col-md-3">
															<div class="form-group">
													...
													<div class="row">															
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="formafarma" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="concentracion" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="presentacion">Presentaci&oacute;n</label>
																<input type="text" class="form-control" id="presentacion" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<select class="form-control form-select" id="nivelriesgo" <?php if($_SESSION['nivel']==='VISOR'){ ?> disabled <?php } ?> >
																	<option value=""></option>
													...
													<div class="row">
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="materialpcb" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<select class="form-control form-select" id="comercializado" <?php if($_SESSION['nivel']==='VISOR'){ ?> disabled <?php } ?> >
																	<option value=""></option>
																	<option value="SI">SI</option>
																	<option value="NO">NO</option>
																	<option value="NO APLICA">NO APLICA</option>
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<select class="form-control form-select" id="labelalemania" <?php if($_SESSION['nivel']==='VISOR'){ ?> disabled <?php } ?> >
																	<option value=""></option>
																	<option value="SI">SI</option>
																	<option value="NO">NO</option>
																	<option value="NO APLICA">NO APLICA</option>
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<input type="text" class="form-control" id="exoneracioncm" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>		
														<div class="col-md-3">
															<div class="form-group">
																<label for="proyectoart">Proyecto</label>
																<select class="form-control form-select" id="proyectoart" <?php if($_SESSION['nivel']==='VISOR'){ ?> disabled <?php } ?> >
																	<option value=""></option>
													...
													<div class="row">														
														...
														<div class="col-md-3">
															<div class="form-group">
																<label for="barraun">Presentacion (unid)</label> <!-- C&oacute;digo de Barras (unid) -->
																<input type="text" class="form-control" id="barraun" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="barracj">C&oacute;digo EAN 13 (caja)</label> <!-- C&oacute;digo de Barras (caja) -->
													...
													<div class="row">
														<div class="col-md-3">
															<div class="form-group">
																<label for="gtinun">C&oacute;digo GTIN (unid)</label> <!-- C&oacute;digo GTIN (unid) -->
																<input type="text" class="form-control" id="gtinun" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="gtincj">C&oacute;digo GTIN (caja)</label> <!-- C&oacute;digo GTIN (caja) -->
																<input type="text" class="form-control" id="gtincj" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="gmdn">GTIN Presentacion (unid)</label> <!-- C&oacute;digo GMDN -->
																<input type="text" class="form-control" id="gmdn" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<label for="umdns">GTIN Presentacion (caja)</label> <!-- C&oacute;digo UMDNS -->
													...
													<div class="row">															
														<div class="col-md-7">
															...
															<div class="form-group">
																...
																<textarea class="form-control" rows="5" placeholder="proyecto" id="proyecto" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> ></textarea>
															</div>
														</div>
														<div class="col-md-5">
															<div class="col-md-12">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="proveedor" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
																</div>
															</div>
															<div class="col-md-12">
																<div class="form-group">
																	<label for="proveedordes">Proveedor Descripci&oacute;n</label>
																	<input type="text" class="form-control" id="proveedordes" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
																</div>
															</div>
														</div>
													</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<textarea class="form-control" rows="3" placeholder="Observaciones" id="observaciones" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> ></textarea>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="file" class="form-control" id="inputFileEdit" aria-describedby="inputFileEditAdd" aria-label="Upload" <?php if($_SESSION['nivel']==='VISOR'){ ?> readonly <?php } ?> >
		...
		<!-- ./modal -->
		<!-- Button trigger modal -->
		<button type="button" id="btnnewmodal" name="btnnewmodal" class="btn btn-primary" data-toggle="modal" data-target="#newModal" hidden>New Modal</button>
		<!-- Modal -->
			...
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
							...
							<div class="col-12">
								<div id="newaccordion">
									<div class="card card-success">
										<div class="card-header">
											<h4 class="card-title w-100">
												<a id="tabarticulo" class="d-block w-100" data-toggle="collapse" href="#collapseOnenew">
												<span id="newartcoddes">Informaci&oacute;n del Producto</span> <i class="fas fa-arrow-circle-right"></i>
												</a>
											</h4>
										</div>
										<div id="collapseOnenew" class="collapse" data-parent="#newaccordion">
											<div class="card-body">
												<div class="row">
													<table id="dtnewproducto" class="table-striped display compact" style="width:100%">
														<thead>
															<tr>
																<th>ID</th>
																<th>C&oacute;digo</th>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" placeholder="Observaciones" id="newobservaciones"></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="file" class="form-control" id="inputFile" aria-describedby="inputFileAdd" aria-label="Upload">
										<button onclick="agregarArchivo()" class="btn btn-outline-secondary" type="button" id="inputFileAdd">Agregar archivo</button>
									</div>
								</div>
					...
					<div class="modal-footer d-flex justify-content-between">
						...
						<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
						<div>
							<button type="button" class="btn-close" data-dismiss="modal" data-target="#newModal" aria-label="Close" id="modnewcierra" hidden></button>
							<button type="button" class="btn btn-success" onclick="newguardar()">Guardar Nuevo Registro</button>
						</div>
					</div>
				</div>
			</div>
		...
		<!-- ./modal -->
		<!-- Button trigger modal -->
		<button type="button" id="btnmasivomodal" name="btnmasivomodal" class="btn btn-primary" data-toggle="modal" data-target="#modalproductomasivo" hidden>Masivo Modal</button>
		<!-- modal -->
		<div class="modal fade" id="modalproductomasivo" data-backdrop="static" data-keyboard="false" aria-labelledby="masivoModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="file" class="form-control" id="inputFileMasivo" aria-describedby="inputFileMasivoAdd" accept=".xlsx, .xls" aria-label="Upload">
										<button onclick="agregarArchivoMasivo()" class="btn btn-outline-secondary" type="button" id="inputFileMasivoAdd" hidden><i class="fas fa-plus-square"></i> Agregar archivo</button>
									</div>
								</div>
						...
						<div><p class="text-danger">- El proceso de actualizaci&oacute;n masiva requiere siempre información en el campo ArtCodigo.</p></div>
						<div><p class="text-danger">- El proceso de actualizaci&oacute;n masiva actualizar&aacute; solo productos con la condici&oacute;n comercializado = "SI".</p></div>
						<div><p class="text-danger">- El proceso de actualizaci&oacute;n masiva tomar&aacute; en cuenta solamente los campos con informaci&oacute;n.</p></div>
					</div>
					<div class="modal-footer d-flex justify-content-between">
						<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
						<button type="button" class="btn-close" data-dismiss="modal" data-target="#modalproductomasivo" aria-label="Close" id="modalproductomasivocierra" hidden></button>
						<div>
		...
		<!-- /.modal -->	
		<!-- Button trigger modal -->
		<button type="button" id="btncreamodal" name="btncreamodal" class="btn btn-primary" data-toggle="modal" data-target="#modalproductocrea" hidden>Crea Producto</button>
		<!-- modal -->
		<div class="modal fade" id="modalproductocrea" data-backdrop="static" data-keyboard="false" aria-labelledby="masivoModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
					...
					<div class="modal-body">
						...
						<div><p class="text-danger">- La informaci&oacute;n adicional del producto podr&aacute; ser agregada posterior a la asignación del RS.</p></div>
					</div>
					<div class="modal-footer d-flex justify-content-between">
						<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
						<button type="button" class="btn-close" data-dismiss="modal" data-target="#modalproductocrea" aria-label="Close" id="modalproductocreacierra" hidden></button>
						<div>
